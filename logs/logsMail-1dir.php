...
<?php
  ...
  * As the intruder has made it past all validation the script emails a copy of the file to the your mailbox
  * A administrator can the decide if it is a error or attacker and blacklist that IP from the server
  * ------------------------------------------------------------------------------------------------------------------------------------------------------------------
  */
  
    $to = "YOUR EMAIL";
    $subject = "SUBJECT OF MAIL" . date('Y-m-d-H:i:s');
    ...
    $txt = "<br>".
        ...
        /* 
         * You can also record and superglobals from your page
         * and text input fields that are posted or sessioned info should be posted as it give us a better view of the offender
         * examples of what you would append are below
         */
